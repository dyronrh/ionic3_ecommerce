...
/**
 * Generated class for the InformaciontiendaPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-informaciontienda',
  templateUrl: 'informaciontienda.html',
})
export class InformaciontiendaPage implements OnInit {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad InformaciontiendaPage');
  }
  gotoOferta(){
